...
func (o *RunProgramReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /run-program] runProgram", response, response.Code())
	}
}
...
func (o *RunProgramNotFound) Error() string {
	...
	return fmt.Sprintf("[POST /run-program][%d] runProgramNotFound %s", 404, payload)
}

...
func (o *StationByHashReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *StationByHashOK) Error() string {
	...
	return fmt.Sprintf("[POST /station-by-hash][%d] stationByHashOK %s", 200, payload)
}

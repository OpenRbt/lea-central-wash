...
func (o *GetStationWashConfigVarStringReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /get-wash-config-var-string] getStationWashConfigVarString", response, response.Code())
	}
}
...
func (o *GetStationWashConfigVarStringOK) Error() string {
	...
	return fmt.Sprintf("[POST /get-wash-config-var-string][%d] getStationWashConfigVarStringOK %s", 200, payload)
}

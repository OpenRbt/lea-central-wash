...
func (o *AdvertisingCampaignReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *AdvertisingCampaignOK) Error() string {
	...
	return fmt.Sprintf("[POST /advertising-campaign][%d] advertisingCampaignOK %s", 200, payload)
}

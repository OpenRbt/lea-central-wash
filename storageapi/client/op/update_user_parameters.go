...
// WithArgs adds the args to the update user params
func (o *UpdateUserParams) WithArgs(args UpdateUserBody) *UpdateUserParams {
	o.SetArgs(args)
	return o
}

// SetArgs adds the args to the update user params
func (o *UpdateUserParams) SetArgs(args UpdateUserBody) {
	o.Args = args
}

...
type ClientService interface {
	...
	GetVolume(params *GetVolumeParams, opts ...ClientOption) (*GetVolumeOK, *GetVolumeNoContent, error)
...
*/
func (a *Client) GetVolume(params *GetVolumeParams, opts ...ClientOption) (*GetVolumeOK, *GetVolumeNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {

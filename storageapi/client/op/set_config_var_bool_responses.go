...
func (o *SetConfigVarBoolReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /set-config-var-bool] setConfigVarBool", response, response.Code())
	}
}

...
func (o *GetStationDiscountsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetStationDiscountsOK) Error() string {
	...
	return fmt.Sprintf("[POST /get-station-discounts][%d] getStationDiscountsOK %s", 200, payload)
}

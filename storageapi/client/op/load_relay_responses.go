...
func (o *LoadRelayReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *LoadRelayOK) Error() string {
	...
	return fmt.Sprintf("[POST /load-relay][%d] loadRelayOK %s", 200, payload)
}

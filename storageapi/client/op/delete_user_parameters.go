...
// WithArgs adds the args to the delete user params
func (o *DeleteUserParams) WithArgs(args DeleteUserBody) *DeleteUserParams {
	o.SetArgs(args)
	return o
}

// SetArgs adds the args to the delete user params
func (o *DeleteUserParams) SetArgs(args DeleteUserBody) {
	o.Args = args
}

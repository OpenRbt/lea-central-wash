...
func (o *DispenserStopReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *DispenserStopNotFound) Error() string {
	...
	return fmt.Sprintf("[POST /stop-dispenser][%d] dispenserStopNotFound %s", 404, payload)
}

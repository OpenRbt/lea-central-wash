...
func (o *Run2ProgramReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *Run2ProgramNotFound) Error() string {
	...
	return fmt.Sprintf("[POST /run-2program][%d] run2ProgramNotFound %s", 404, payload)
}

...
func (o *StationStatDatesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *StationStatDatesOK) Error() string {
	...
	return fmt.Sprintf("[POST /station-stat-dates][%d] stationStatDatesOK %s", 200, payload)
}

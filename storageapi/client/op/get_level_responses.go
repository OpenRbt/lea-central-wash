...
func (o *GetLevelReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetLevelOK) Error() string {
	...
	return fmt.Sprintf("[POST /getLevel][%d] getLevelOK %s", 200, payload)
}
...
func (o *GetLevelNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /getLevel][%d] getLevelNotFound %s", 404, payload)
}

...
func (o *GetConfigVarBoolReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetConfigVarBoolOK) Error() string {
	...
	return fmt.Sprintf("[POST /get-config-var-bool][%d] getConfigVarBoolOK %s", 200, payload)
}

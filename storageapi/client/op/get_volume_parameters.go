...
// WithArgs adds the args to the get volume params
func (o *GetVolumeParams) WithArgs(args GetVolumeBody) *GetVolumeParams {
	o.SetArgs(args)
	return o
}

// SetArgs adds the args to the get volume params
func (o *GetVolumeParams) SetArgs(args GetVolumeBody) {
	o.Args = args
}

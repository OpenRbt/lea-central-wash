...
func (o *StationProgramByHashReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *StationProgramByHashOK) Error() string {
	...
	return fmt.Sprintf("[POST /station-program-by-hash][%d] stationProgramByHashOK %s", 200, payload)
}

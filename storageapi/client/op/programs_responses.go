...
func (o *ProgramsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *ProgramsOK) Error() string {
	...
	return fmt.Sprintf("[POST /programs][%d] programsOK %s", 200, payload)
}

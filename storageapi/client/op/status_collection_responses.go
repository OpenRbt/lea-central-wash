...
func (o *StatusCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *StatusCollectionOK) Error() string {
	...
	return fmt.Sprintf("[GET /status-collection][%d] statusCollectionOK %s", 200, payload)
}

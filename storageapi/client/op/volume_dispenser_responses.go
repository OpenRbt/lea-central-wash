...
func (o *VolumeDispenserReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *VolumeDispenserOK) Error() string {
	...
	return fmt.Sprintf("[POST /volume-dispenser][%d] volumeDispenserOK %s", 200, payload)
}
...
func (o *VolumeDispenserNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /volume-dispenser][%d] volumeDispenserNotFound %s", 404, payload)
}

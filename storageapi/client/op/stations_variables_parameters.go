...
// WithDefaults hydrates default values in the stations variables params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StationsVariablesParams) WithDefaults() *StationsVariablesParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the stations variables params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *StationsVariablesParams) SetDefaults() {

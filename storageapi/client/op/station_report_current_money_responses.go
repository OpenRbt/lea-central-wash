...
func (o *StationReportCurrentMoneyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *StationReportCurrentMoneyOK) Error() string {
	...
	return fmt.Sprintf("[POST /station-report-current-money][%d] stationReportCurrentMoneyOK %s", 200, payload)
}

...
func (o *StationStatCurrentReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *StationStatCurrentOK) Error() string {
	...
	return fmt.Sprintf("[POST /station-stat-current][%d] stationStatCurrentOK %s", 200, payload)
}

...
func (o *GetConfigVarStringReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /get-config-var-string] getConfigVarString", response, response.Code())
	}
}
...
func (o *GetConfigVarStringOK) Error() string {
	...
	return fmt.Sprintf("[POST /get-config-var-string][%d] getConfigVarStringOK %s", 200, payload)
}

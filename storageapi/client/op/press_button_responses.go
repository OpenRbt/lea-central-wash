...
func (o *PressButtonReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *PressButtonNotFound) Error() string {
	...
	return fmt.Sprintf("[POST /press-button][%d] pressButtonNotFound %s", 404, payload)
}

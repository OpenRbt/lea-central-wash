...
func (o *LoadFromStationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *LoadFromStationOK) Error() string {
	...
	return fmt.Sprintf("[POST /load-from-station][%d] loadFromStationOK %s", 200, payload)
}

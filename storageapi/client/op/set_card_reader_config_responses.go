...
func (o *SetCardReaderConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *SetCardReaderConfigUnprocessableEntity) Error() string {
	...
	return fmt.Sprintf("[POST /set-card-reader-config][%d] setCardReaderConfigUnprocessableEntity %s", 422, payload)
}

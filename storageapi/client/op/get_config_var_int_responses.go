...
func (o *GetConfigVarIntReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetConfigVarIntOK) Error() string {
	...
	return fmt.Sprintf("[POST /get-config-var-int][%d] getConfigVarIntOK %s", 200, payload)
}

...
func (o *GetStationWashConfigVarBoolReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetStationWashConfigVarBoolOK) Error() string {
	...
	return fmt.Sprintf("[POST /get-wash-config-var-bool][%d] getStationWashConfigVarBoolOK %s", 200, payload)
}

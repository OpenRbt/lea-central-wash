...
func (o *KasseReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *KasseOK) Error() string {
	...
	return fmt.Sprintf("[POST /kasse][%d] kasseOK %s", 200, payload)
}

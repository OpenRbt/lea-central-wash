...
func (o *MeasureVolumeMillilitersReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *MeasureVolumeMillilitersNotFound) Error() string {
	...
	return fmt.Sprintf("[POST /run-dispenser][%d] measureVolumeMillilitersNotFound %s", 404, payload)
}

...
func (o *StationButtonReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *StationButtonOK) Error() string {
	...
	return fmt.Sprintf("[POST /station-button][%d] stationButtonOK %s", 200, payload)
}

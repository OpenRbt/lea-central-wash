...
func (o *AdvertisingCampaignByIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *AdvertisingCampaignByIDOK) Error() string {
	...
	return fmt.Sprintf("[POST /advertising-campaign-by-id][%d] advertisingCampaignByIdOK %s", 200, payload)
}

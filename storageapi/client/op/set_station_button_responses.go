...
func (o *SetStationButtonReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *SetStationButtonUnprocessableEntity) Error() string {
	...
	return fmt.Sprintf("[POST /set-station-button][%d] setStationButtonUnprocessableEntity %s", 422, payload)
}

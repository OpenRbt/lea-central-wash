...
func (o *StationReportDatesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *StationReportDatesOK) Error() string {
	...
	return fmt.Sprintf("[POST /station-report-dates][%d] stationReportDatesOK %s", 200, payload)
}

...
// WithArgs adds the args to the refresh session params
func (o *RefreshSessionParams) WithArgs(args RefreshSessionBody) *RefreshSessionParams {
	o.SetArgs(args)
	return o
}

// SetArgs adds the args to the refresh session params
func (o *RefreshSessionParams) SetArgs(args RefreshSessionBody) {
	o.Args = args
}

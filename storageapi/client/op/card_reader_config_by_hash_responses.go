...
func (o *CardReaderConfigByHashReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CardReaderConfigByHashOK) Error() string {
	...
	return fmt.Sprintf("[POST /card-reader-config-by-hash][%d] cardReaderConfigByHashOK %s", 200, payload)
}

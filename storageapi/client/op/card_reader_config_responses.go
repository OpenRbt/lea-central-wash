...
func (o *CardReaderConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *CardReaderConfigOK) Error() string {
	...
	return fmt.Sprintf("[POST /card-reader-config][%d] cardReaderConfigOK %s", 200, payload)
}

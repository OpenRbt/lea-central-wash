...
func (o *LoadMoneyReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /load-money] loadMoney", response, response.Code())
	}
}
...
func (o *LoadMoneyOK) Error() string {
	...
	return fmt.Sprintf("[POST /load-money][%d] loadMoneyOK %s", 200, payload)
}

...
func (o *GetStationConfigVarIntReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *GetStationConfigVarIntOK) Error() string {
	...
	return fmt.Sprintf("[POST /get-station-config-var-int][%d] getStationConfigVarIntOK %s", 200, payload)
}

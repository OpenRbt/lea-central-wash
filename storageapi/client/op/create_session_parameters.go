...
// WithArgs adds the args to the create session params
func (o *CreateSessionParams) WithArgs(args CreateSessionBody) *CreateSessionParams {
	o.SetArgs(args)
	return o
}

// SetArgs adds the args to the create session params
func (o *CreateSessionParams) SetArgs(args CreateSessionBody) {
	o.Args = args
}

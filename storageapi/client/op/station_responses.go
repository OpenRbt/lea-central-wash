...
func (o *StationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *StationOK) Error() string {
	...
	return fmt.Sprintf("[POST /station][%d] stationOK %s", 200, payload)
}

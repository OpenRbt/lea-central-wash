...
// WithArgs adds the args to the create task params
func (o *CreateTaskParams) WithArgs(args *model.CreateTask) *CreateTaskParams {
	o.SetArgs(args)
	return o
}

// SetArgs adds the args to the create task params
func (o *CreateTaskParams) SetArgs(args *model.CreateTask) {
	o.Args = args
}

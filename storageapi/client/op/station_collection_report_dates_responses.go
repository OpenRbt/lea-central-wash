...
func (o *StationCollectionReportDatesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *StationCollectionReportDatesOK) Error() string {
	...
	return fmt.Sprintf("[POST /station-collection-report-dates][%d] stationCollectionReportDatesOK %s", 200, payload)
}

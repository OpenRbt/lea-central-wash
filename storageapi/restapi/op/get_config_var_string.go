...
type GetConfigVarStringHandlerFunc func(GetConfigVarStringParams) GetConfigVarStringResponder

// Handle executing the request and returning a response
func (fn GetConfigVarStringHandlerFunc) Handle(params GetConfigVarStringParams) GetConfigVarStringResponder {
	return fn(params)
}
...
type GetConfigVarStringHandler interface {
	Handle(GetConfigVarStringParams) GetConfigVarStringResponder
}

...
type StatusHandlerFunc func(StatusParams) StatusResponder

// Handle executing the request and returning a response
func (fn StatusHandlerFunc) Handle(params StatusParams) StatusResponder {
	return fn(params)
}

// StatusHandler interface for that can handle valid status params
type StatusHandler interface {
	Handle(StatusParams) StatusResponder
}

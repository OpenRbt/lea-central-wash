...
type GetConfigVarIntHandlerFunc func(GetConfigVarIntParams) GetConfigVarIntResponder

// Handle executing the request and returning a response
func (fn GetConfigVarIntHandlerFunc) Handle(params GetConfigVarIntParams) GetConfigVarIntResponder {
	return fn(params)
}
...
type GetConfigVarIntHandler interface {
	Handle(GetConfigVarIntParams) GetConfigVarIntResponder
}

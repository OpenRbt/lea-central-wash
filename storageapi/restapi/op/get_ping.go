...
type GetPingHandlerFunc func(GetPingParams) GetPingResponder

// Handle executing the request and returning a response
func (fn GetPingHandlerFunc) Handle(params GetPingParams) GetPingResponder {
	return fn(params)
}

// GetPingHandler interface for that can handle valid get ping params
type GetPingHandler interface {
	Handle(GetPingParams) GetPingResponder
}

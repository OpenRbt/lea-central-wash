...
// SaveIfNotExistsParams contains all the bound params for the save if not exists operation
// typically these are obtained from a http.Request
//
// swagger:parameters saveIfNotExists
...
//
// To ensure default values, the struct must have been initialized with NewSaveIfNotExistsParams() beforehand.
func (o *SaveIfNotExistsParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error

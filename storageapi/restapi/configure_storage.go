...
func configureAPI(api *op.StorageAPI) http.Handler {
	...
	if api.GetVolumeHandler == nil {
		api.GetVolumeHandler = op.GetVolumeHandlerFunc(func(params op.GetVolumeParams) op.GetVolumeResponder {
			return op.GetVolumeNotImplemented()
		})
	}

...
func (c *hardwareAccessLayerClient) Value(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Otvet, error) {
	out := new(Otvet)
	err := c.cc.Invoke(ctx, "/xgrpc.HardwareAccessLayer/Value", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHardwareAccessLayerServer) Value(context.Context, *emptypb.Empty) (*Otvet, error) {
...
func _HardwareAccessLayer_Value_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HardwareAccessLayerServer).Value(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xgrpc.HardwareAccessLayer/Value",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HardwareAccessLayerServer).Value(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HardwareAccessLayer_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Value",
			Handler:    _HardwareAccessLayer_Value_Handler,
		},
	},

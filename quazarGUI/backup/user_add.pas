...
begin
  ...
  try
     try
        ...
        if UserAddForm.StatusEdit.ItemIndex = UsersForm.ADMIN_ROLE then
        begin
            userJson.Add('isAdmin', true);
        end
        else if UserAddForm.StatusEdit.ItemIndex = UsersForm.ENGINEER_ROLE then
        begin
            userJson.Add('isEngineer', true);
        end
        else if UserAddForm.StatusEdit.ItemIndex = UsersForm.OPERATOR_ROLE then
        begin

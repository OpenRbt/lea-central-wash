...
//go:generate swagger generate server --api-package op --model-package model -f ./storageapi/swagger.yml -t ./storageapi --strict-responders --strict-additional-properties --principal github.com/OpenRbt/lea-central-wash/storageapi.Profile --exclude-main
//go:generate swagger generate client --api-package op --model-package model -f ./storageapi/swagger.yml -t ./storageapi --strict-responders --strict-additional-properties --principal github.com/OpenRbt/lea-central-wash/storageapi.Profile
